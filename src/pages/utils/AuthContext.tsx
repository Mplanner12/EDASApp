...
// import { createContext, useContext, useState, useEffect } from 'react';
// import { account, users } from '../appwriteConfig';
...
//         // if the user does not have the account scope, grant them the scope
//         await users.updateRole('unique()', {
//           scopes: ['account'],
//         });
//         // try to get the account details again
//         accountDetails = await account.get();
//         setUser(accountDetails); // if user is logged in, set the user state to the account details
//       } else {
//         navigate('/auth/signin'); // if user is not logged in, redirect the user to the login page
