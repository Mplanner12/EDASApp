...
const Profile = () => {
  ...
  return (
    <div
      ...
      className="flex-col h-screen justify-center text-center"
    >
      <h1 className="font-extrabold text-green-950 relative top-5">
        Welcome to your Dashboard! {user.name}
      </h1>
      <div className="overflow-hidden rounded-sm bg-none text-white shadow-default">
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="mt-4 md:mt-20">
            ...
            <div className="mt-6">
              <h4 className="mb-3.5 font-bold text-white md:text-black md:mt-20">
                Contact us on
              </h4>
